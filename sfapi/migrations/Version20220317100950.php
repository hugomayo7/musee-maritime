 ...
 */
final class Version20220317100950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, id_boat_id INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_C53D045F7F75E359 (id_boat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE visit (id INT AUTO_INCREMENT NOT NULL, id_boat_id INT NOT NULL, day VARCHAR(255) NOT NULL, maximum_places INT NOT NULL, actual INT NOT NULL, visit_time INT DEFAULT NULL, INDEX IDX_437EE9397F75E359 (id_boat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
